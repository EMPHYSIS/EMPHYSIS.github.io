# Contributing to the emphysis.github.io website
...
The [tools page](https://emphysis.github.io/tools/) is the central location to find and get information about tools that support eFMI.
The page is currently manually edited.
If your tool should be added to this page, send an email to martin.otter (at) dlr.de
...
```
https://emphysis.github.io/news/2018/09/04/modelica-conference-2019-regensburg-germany.html
```
...
```markdown
---
title: eFMI at the 14th Modelica Conference 2021
categories: [news]
layout: post
---

The [14th International Modelica Conference](https://modelica.org/events/modelica2021) will be held online and organized
by [Linköping University](https://liu.se/).

The scope of the conference includes eFMI in Modelica and non-Modelica applications and tools.
```
